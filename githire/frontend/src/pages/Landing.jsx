    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      <nav style={{
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <Link to="/login" className="btn-ghost" style={{ textDecoration: 'none', padding: '8px 16px', fontSize: '13px' }}>
            Sign in
          </Link>
          <Link to="/register" className="btn-primary" style={{ textDecoration: 'none', padding: '8px 16px', fontSize: '13px' }}>
            Sign up
          </Link>
        </div>
      </nav>
      ...
      <div style={{
        ...
        <p style={{
          ...
          Analyse any GitHub profile instantly. Organise candidates into projects and use AI to rank them against your job requirements.
        </p>
        ...
        {[
          {
            ...
            description: 'Paste any GitHub URL and instantly see language breakdowns, repository stats, and activity patterns. No sign up required.',
          },
          {
            icon: '📁',
            title: 'Organise by Project',
            description: 'Create hiring projects and add multiple candidates to each one. Keep your recruitment organised and efficient.',
          },
          {
            icon: '⚡',
            title: 'AI-Powered Matching',
            description: 'Enter job requirements and let AI rank candidates by match score, highlighting strengths and skill gaps. (Only to be utilized for technical skills visible on GitHub such as programming languages, frameworks, and tools.)',
          },
        ].map(feature => (
          <div key={feature.title} className="glass-card" style={{ padding: '28px' }}>
            <div style={{ fontSize: '32px', marginBottom: '16px' }}>{feature.icon}</div>
            <h3 style={{ fontSize: '16px', fontWeight: '600', color: '#f8fafc', marginBottom: '10px' }}>
              {feature.title}
            </h3>
              ...
              <div style={{ display: 'flex', gap: '20px', alignItems: 'flex-start' }}>
                ...
                <div style={{ flex: 1 }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px' }}>
                    <div>
                      <h2 style={{ fontSize: '22px', fontWeight: '700', color: '#f8fafc', marginBottom: '4px' }}>
                  ...
                  <div style={{ display: 'flex', gap: '32px', marginTop: '16px', flexWrap: 'wrap' }}>
                    {[
                      { label: 'Repositories', value: profileData.profile?.public_repos },
                      { label: 'Followers', value: profileData.profile?.followers },
                      { label: 'Following', value: profileData.profile?.following },
                    ].map(stat => (
                      <div key={stat.label}>
                    ...
                    {profileData.topRepos?.map(repo => (
                      ...
                      >
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
                          ...
                          <span style={{ fontSize: '12px', color: '#94a3b8' }}>⭐ {repo.stars}</span>
                        </div>
                        {repo.description && (
                ...
                {profileData.allRepos?.map(repo => (
                  ...
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <div>
                        <span style={{ fontSize: '14px', fontWeight: '600', color: '#a78bfa', display: 'block', marginBottom: '4px' }}>
                          {repo.name}
                        </span>
                        {repo.description && (
                          <span style={{ fontSize: '13px', color: '#94a3b8' }}>{repo.description}</span>
                        )}
                      </div>
                ...
                {activityData.length > 0 ? (
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart data={activityData}>
                      ...
                      />
                      <Bar dataKey="count" fill="#7c3aed" radius={[4, 4, 0, 0]} name="Repos updated" />
                    </BarChart>
                  </ResponsiveContainer>
                ) : (
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{ fontSize: '13px', color: '#94a3b8', lineHeight: '1.5' }}>
                  Sign up to save candidates, create hiring projects, and use AI to rank them by match score.
                </p>
              </div>
              <button
                className="btn-primary"
